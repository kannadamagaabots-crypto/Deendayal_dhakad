...
API_ID = int(environ.get('API_ID', '36323320'))
API_HASH = environ.get('API_HASH', '33e6a715e69b1758bcc32bf3db61a84b')
...
PICS = (environ.get('PICS', 'https://i.ibb.co/XrTRrVbZ/x.jpg')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5709286204').split()] # Replace with the actual admin ID(s) to add
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002688443781'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001913629397'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1003757820653')  # Channel/Group ID for force sub (make sure bot is admin)
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1003757820653').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1003757820653').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/XrTRrVbZ/x.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'NA')

# ============================
# MongoDB Configuration
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://KR:KR@cluster0.gsa64.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://KR1:KR1@cluster0.xoqesjy.mongodb.net/?retryWrites=true&w=majority")
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/How_To_Link_Open_Vplinks')  # How to open tutorial link for verification
...
SHORTLINK_API = environ.get('SHORTLINK_API', '0ea93ffa439f72f9f480ee551bdc891991aa6544')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Link_Open_Vplinks')  # Tutorial video link for opening shortlink website
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))

# ============================
# Channel & Group Links Configuration
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+gNJvQe2UJR4yMDA1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+6ZgZpXxl0xo4NzA1')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/KARNATAKA_BLASTER')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/KARNATAKA_BLASTER')
OWNERID = int(os.environ.get('OWNERID', '5709286204'))  # Replace with the actual admin ID
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+gNJvQe2UJR4yMDA1')  # Support group link (make sure bot is admin)
